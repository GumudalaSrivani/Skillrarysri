...
/**
 * This class contains all reusable methods to perform driver related operation
 * @author aravi
 */
...
public class WedDriverUtility {
  ...
  */
		 ...
		 /**
		  * This method waits until element is displayed on the wed page
		  * @param element
		  * @param time
		  * @return
		  */
	 ...
	 * @param element
	 */
	public void rightClickWebElement(WebElement element) {
		Actions action = new Actions(driver);
	...
	/**
	 * This method is used to select an element from drop and down based on index
	 * @param element
	 * @param index
	 */
	...
	/**
	 * This method is used to select an element from drop and down based on value
	 * @param element
	 * @param value
	 */
	...
	/**
	 * This method is used to select an element from drop and down based on visible text
	 * @param text
	 * @param element
	 */
